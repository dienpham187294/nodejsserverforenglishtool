...
const sents1000WMeaning = require("../../../database/1000sentsWithMeaning.json")
...
let ArrPassword = pickNRandomElementsOfArray(shuffleArr(sents1000WMeaning), 30)
let ArrOfSubmit;
...
function getOutputT(DATAUSE) {
    ...
    DATAUSE.forEach((e, iM) => {
        ...
        Des = Des.concat(e.des)
        let passwordInX = ArrPassword[iM % 30].Sents

        Des.push("Password: " + ArrPassword[iM % 30].Meaning)
